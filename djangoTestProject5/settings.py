"""
Django settings for djangoTestProject5 project.
...
# SECRET_KEY = 'django-insecure-9tyr%y^08!71q68s#5geux9)ub*zoey5zpuoc(i=q#baz&qiq1'
...
WSGI_APPLICATION = 'djangoTestProject5.wsgi.application'
